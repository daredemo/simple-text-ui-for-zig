...
const union_unnamed_21 = extern union {
    _pad: [12]c_int,
    _tid: __pid_t,
    _sigev_thread: struct_unnamed_22,
};
pub const struct_sigevent = extern struct {
    ...
    _sigev_un: union_unnamed_21 = @import("std").mem.zeroes(union_unnamed_21),
};
...
pub const struct_sigaction = extern struct {
    __sigaction_handler: union_unnamed_24 = @import("std").mem.zeroes(union_unnamed_24),
